...
# Criando os objetos que se movem no jogo

class Passaro:
    IMGS = IMAGEM_PASSARO
    # Definindo as animações das rotações
    ROTACAO_MAXIMA = 25
    ...
    def mover(self):
        ...
        if deslocamento > 16:
            ...
            deslocamento -= 2  # Aumenta o tamanho do pulo do passaro

        self.y += deslocamento

        # Angulo do passaro
        if deslocamento < 0 or self.y < (self.altura + 50):  # ta ajustando o bico do passaro depois que ele pula
    ...
    def desenhar(self, tela):
        ...
        if self.angulo <= -80:
            ...
            # para definir que a porxima batida de asa dele vai ser para baixo
...
class Cano:
    DISTANCIA = 200  # Distancia entre os canos, do de baixo e o de cima
    VELOCIDADE = 5  # VElocidade de movimento dos anos
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto = FONTE_PONTOS.render(f'{pontos}', True, (255, 255, 255))
...
def main():
    passaros = [Passaro(230, 350)]  # Posição do passaro
    chao = Chao(730)
    canos = [Cano(700)]
